...
describe('SoundFile', function() {
  ...
  describe('getBlock', function() {
    ...
    it('should loop through a file if loop=true', function(done) {
      var soundfile = new audionodes.SoundFile(__dirname + '/sounds/stepsShort.wav', {loop: true})
        , blocks = []
    ...
    it('should read mp3 files', function(done) {
      var soundfile = new audionodes.SoundFile(__dirname + '/sounds/steps.mp3')
        , blocks = []
